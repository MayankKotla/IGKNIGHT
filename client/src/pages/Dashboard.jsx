      ...
      <main className="flex-1 overflow-y-auto overflow-x-hidden relative">
        ...
        <div className="relative min-h-full flex flex-col overflow-hidden">
          <InteractiveGridPattern
            className="z-0 inset-x-0 inset-y-[-40%] h-[180%] skew-y-12 [mask-image:linear-gradient(115deg,white_0%,white_10%,rgba(255,255,255,0.55)_30%,rgba(255,255,255,0.2)_50%,transparent_70%)]"
          />
